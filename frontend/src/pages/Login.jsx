...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Don't clear fields on error - let user see what they typed
    } finally {
      setLoading(false)
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-accent-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-display text-2xl font-bold">Study Match</span>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight">
            ...
            <span className="text-primary-200">Study Partner</span>
          </h1>
          <p className="text-primary-100 text-lg max-w-md">
            Connect with students who share your goals, schedule, and learning style. 
          ...
          <div className="flex items-center gap-4 pt-4">
            <div className="flex -space-x-3">
              {['A', 'B', 'C', 'D'].map((letter, i) => (
                <div
                  key={letter}
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-white/30 to-white/10 backdrop-blur border-2 border-white/30 flex items-center justify-center text-white text-sm font-medium"
                  style={{ zIndex: 4 - i }}
                >
                  {letter}
                </div>
            ...
            <p className="text-primary-100 text-sm">
              <span className="font-semibold text-white">500+</span> students matched
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-2 text-primary-200 text-sm">
          ...
          <span>AI-powered matching for optimal study partnerships</span>
        </div>
      </div>
          ...
          <div className="card p-8">
            ...
            <div className="mb-4 p-3 rounded-xl bg-gradient-to-r from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 border border-primary-200 dark:border-primary-800">
              <p className="text-sm text-center text-primary-700 dark:text-primary-300 font-medium flex items-center justify-center gap-2">
                <Sparkles className="w-4 h-4" />
                We recommend signing in with Google for a seamless experience
              </p>
            </div>
